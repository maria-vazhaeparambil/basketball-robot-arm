"""Show the actual robot in RVIZ (moved by hand)

   This does not create joint commands, so you can move the robot by hand.

   This should start
     1) RVIZ, ready to view the robot
     2) The robot_state_publisher (listening to /joint_states)
     3) The HEBI node to read the motor angles
